    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 col-12 mb-5">
                ...
                <h2 class="text-white">Agenda Kegiatan <br> {{ $masjid->nama ?? 'E Masjid' }}</h2>
            </div>
    ...
    <div class="container">
        ...
        @if($kajian->isEmpty())
            <div class="text-center py-5">
                <p class="text-muted">Belum ada Agenda Kegiatan tersedia.</p>
            </div>
        @else
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ Str::limit($item->keterangan, 120) }}</p>

                            <a href="{{ route('frontend.kajian.detail', $item) }}" class="btn btn-primary btn-sm mt-2">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
